...
//    Int_t bin = h2->GetBin(xbin,ybin,1);
    //cout << "quark content : " <<h_p_nconstit_frac_quark->GetBinContent(ib+1)<<endl; 
    //cout << "gluon content : " <<h_p_nconstit_frac_gluon->GetBinContent(ib+1)<<endl; 
