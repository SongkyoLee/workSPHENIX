...
void SetLineHistStyle(TH1* h, Int_t c) {
  Int_t lineColorArr[] = { kGray+3, kPink+3, kAzure+4, kSpring+3, kGray+3, kPink+3, kAzure+4, kSpring+3, kGray+3, kPink+3 };
  Int_t fillColorArr[] = { kWhite, kPink+2, kAzure+5, kSpring+9, kWhite, kPink+2, kAzure+5, kSpring+9, kWhite, kPink+2 };
  Int_t fillStyleArr[] = {0,3445,3454,3003,0,3445,3454,3003,0,3445};
  h-> SetLineColor(lineColorArr[c]);
  h-> SetFillColor(fillColorArr[c]);
  h-> SetFillStyle(fillStyleArr[c]);
  h-> SetMarkerSize(0);
  //h-> SetLineWidth(1.); //follow sPHENIX style
