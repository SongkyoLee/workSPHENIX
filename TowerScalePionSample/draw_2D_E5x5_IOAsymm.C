...
void draw_2D_E5x5_IOAsymm(string outDir = "out2D_E5x5_IOAsymm",
                           ...
                           bool do_profile=true)
{
  ...
  if (inType.compare("SS310_25GeV")==0){ 
    ...
    if (do_ihcalScale) ihcal_sf=1.86;
    ...
    ptlType = "#pi^{#pm}";
    if (do_cemcScale) cemc_sf=1.;
    if (do_ihcalScale) ihcal_sf=4.24;
    if (do_ohcalScale) ohcal_sf=1.;
  }
  ...
  //tr01->Draw(Form("(cemc_E5x5*%2f+ihcal_E5x5*%2f+ohcal_E5x5*%2f):((ihcal_E5x5*%2f-ohcal_E5x5*%2f)/(ihcal_E5x5*%2f+ohcal_E5x5*%2f))>>h2d01",cemc_sf,ihcal_sf,ohcal_sf,ihcal_sf,ohcal_sf,ihcal_sf,ohcal_sf),Form("cemc_E5x5<%2f && ihcal_E5x5<%2f && (cemc_E5x5+ihcal_E5x5+ohcal_E5x5)>%2f",cemcCut,ihcalCut,totCut));
  //tr02->Draw(Form("(cemc_E5x5*%2f+ihcal_E5x5*%2f+ohcal_E5x5*%2f):((ihcal_E5x5*%2f-ohcal_E5x5*%2f)/(ihcal_E5x5*%2f+ohcal_E5x5*%2f))>>+h2d01",cemc_sf,ihcal_sf,ohcal_sf,ihcal_sf,ohcal_sf,ihcal_sf,ohcal_sf),Form("cemc_E5x5<%2f && ihcal_E5x5<%2f && (cemc_E5x5+ihcal_E5x5+ohcal_E5x5)>%2f",cemcCut,ihcalCut,totCut));
  tr01->Draw(Form("(ihcal_E5x5*%2f+ohcal_E5x5*%2f):((ihcal_E5x5*%2f-ohcal_E5x5*%2f)/(ihcal_E5x5*%2f+ohcal_E5x5*%2f))>>h2d01",ihcal_sf,ohcal_sf,ihcal_sf,ohcal_sf,ihcal_sf,ohcal_sf),Form("cemc_E5x5<%2f && ihcal_E5x5<%2f && (cemc_E5x5+ihcal_E5x5+ohcal_E5x5)>%2f",cemcCut,ihcalCut,totCut));
  tr02->Draw(Form("(ihcal_E5x5*%2f+ohcal_E5x5*%2f):((ihcal_E5x5*%2f-ohcal_E5x5*%2f)/(ihcal_E5x5*%2f+ohcal_E5x5*%2f))>>+h2d01",ihcal_sf,ohcal_sf,ihcal_sf,ohcal_sf,ihcal_sf,ohcal_sf),Form("cemc_E5x5<%2f && ihcal_E5x5<%2f && (cemc_E5x5+ihcal_E5x5+ohcal_E5x5)>%2f",cemcCut,ihcalCut,totCut));
  ...
  if (do_profile){
    ...
    if (form02) { 
      ...
      latex->DrawLatex(0.85,0.81,"(5x5 towers)");
      latex->SetTextAlign(12);
  ...
  c01->SaveAs(Form("%s/%s_2D_E5x5_HCALE_vs_IOAsymm_%.0f_%.0f_%.0f_mipcut_%.0f_%.0f_totcut%.0f.pdf",outDir.c_str(),inType.c_str(),(int)do_cemcScale*cemc_sf*100,(int)do_ihcalScale*ihcal_sf*100,(int)do_ohcalScale*ohcal_sf*100,(int)do_cemcMipCut*cemcCut*100,(int)do_ihcalMipCut*ihcalCut*100,(int)do_totMipCut*totCut*100));
