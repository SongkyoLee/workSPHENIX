...
foreach outdir (out2D_E5x5_IOAsymm)
  echo "***Run for" $outdir
  foreach intype (SS310_25GeV Al_25GeV SS310_10GeV Al_10GeV)
#  foreach intype (SS310_25GeV SS310_10GeV)
    echo $intype
    ### NoScale
    root -l -b -q 'draw_2D_E5x5_IOAsymm.C("'$outdir'","'$intype'",false,false,false,false,false,false,true)'
    ### IHCALscale
    #root -l -b -q 'draw_2D_E5x5_IOAsymm.C("'$outdir'","'$intype'",false,true,false,false,false,false,true)'
  end
end
