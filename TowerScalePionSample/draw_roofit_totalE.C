...
void draw_roofit_totalE(string outDir = "outTotalE",
                           ...
                           bool do_doubleGaus = true)
{
  ...
  cout << "tr01 =" << tr01 << endl;
  cout << "tr02 =" << tr02 << endl;
  tr01->Draw(Form("(cemc_E3x3*%2f+ihcal_E3x3*%2f+ohcal_E3x3*%2f)>>h01",cemc_sf,ihcal_sf,ohcal_sf),Form("cemc_E3x3<%2f && ihcal_E3x3<%2f && (cemc_E3x3+ihcal_E3x3+ohcal_E3x3) > %2f",cemcCut,ihcalCut,totCut));
  tr02->Draw(Form("(cemc_E3x3*%2f+ihcal_E3x3*%2f+ohcal_E3x3*%2f)>>+h01",cemc_sf,ihcal_sf,ohcal_sf),Form("cemc_E3x3<%2f && ihcal_E3x3<%2f && (cemc_E3x3+ihcal_E3x3+ohcal_E3x3) > %2f",cemcCut,ihcalCut,totCut));
