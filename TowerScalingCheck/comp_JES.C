void comp_JES(double ptmin = 50, double ptmax = 531, double etacut = 0.6, double dRcut = 0.4, string varType="pt"){
  ...
  TFile* f01 = new TFile("./out_emfrac/emfrac_100MeV_Al_NotScaled_v3.root","READ");
  ...
  TFile* f02 = new TFile("./out_emfrac/emfrac_OnlyHcalScaled.root","READ");
  ...
  c1->SaveAs("./out_emfrac/JEScomparsion.pdf"); 
