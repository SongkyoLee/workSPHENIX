...
void rootAna_2ndSort_qcdjet_kpp_pt(string sampleType = "QCDJet",
                              string ihcalType = "Al",
                              string jetInE = "20GeV",
                              ...
                              bool dodphicut=true)
{
  ...
  //////////////////////////////////////////////////////////////////////////// 
  //// write new tree
  //string foutname = Form("./2ndSortedRootFiles/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_doetopcut%d_dodphicut%d.root",initfile,endfile,sampleType.c_str(),jetOutE.c_str(),ihcalType.c_str(),(int)doetopcut,(int)dodphicut);
  ...
  ////////////////////////////////////// 
  string fname;
  //if (vtxType.compare("nover")==0 && ihcalType.compare("Al")==0) { fname = Form("./sortedRootFiles/sorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_%s_doetopcut%d_dodphicut%d.root",initfile,endfile,sampleType.c_str(),jetInE.c_str(),ihcalType.c_str(),vtxType.c_str(),(int)doetopcut,(int)dodphicut); }
  //else if (vtxType.compare("nover")==0) { fname = Form("./sortedRootFiles/sorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_doetopcut%d_dodphicut%d.root",initfile,endfile,sampleType.c_str(),jetInE.c_str(),ihcalType.c_str(),(int)doetopcut,(int)dodphicut); }
  ...
  fname = Form("./sortedRootFiles/sorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_%s_doetopcut%d_dodphicut%d.root",initfile,endfile,sampleType.c_str(),jetInE.c_str(),ihcalType.c_str(),vtxType.c_str(),(int)doetopcut,(int)dodphicut);
  ...
  //for (int ievt=0; ievt<50; ievt++){ 
    ...
    for (int itrue=0; itrue<true_n; itrue++){
      ...
      ////////// cut on truth //////////
      if (jetOutE.compare("allGeV")==0){ if (!(true_pt[itrue] > 20)) continue;}
...
/*
      else if (jetOutE.compare("20GeV")==0){ if (!(true_pt[itrue] > 20 && true_pt[itrue] <25)) continue;}
      else if (jetOutE.compare("25GeV")==0){ if (!(true_pt[itrue] > 25 && true_pt[itrue] <30)) continue;}
      else if (jetOutE.compare("30GeV")==0){ if (!(true_pt[itrue] > 30 && true_pt[itrue] <35)) continue;}
      else if (jetOutE.compare("35GeV")==0){ if (!(true_pt[itrue] > 35 && true_pt[itrue] <40)) continue;}
      else if (jetOutE.compare("40GeV")==0){ if (!(true_pt[itrue] > 40 && true_pt[itrue] <45)) continue;}
      else if (jetOutE.compare("45GeV")==0){ if (!(true_pt[itrue] > 45 && true_pt[itrue] <50)) continue;}
      else if (jetOutE.compare("50GeV")==0){ if (!(true_pt[itrue] > 50 && true_pt[itrue] <55)) continue;}
      else if (jetOutE.compare("55GeV")==0){ if (!(true_pt[itrue] > 55 && true_pt[itrue] <60)) continue;}
*/
      ...
      if (vtxType.compare("R04")==0) { if (match_jet_dR > 0.4) continue; }
      if (vtxType.compare("R02")==0) { if (match_jet_dR > 0.2) continue; }
