...
void jes_threefile_nofit(string sampleType = "QCDJet",
                 string ihcalType = "Al",
                 string jetE = "20GeV",
                 string vtxType = "R04",
                 int initfile=0,
                 ...
                 bool dodphicut=true)
{
  ...
  if (vtxType.compare("R04")==0) h_JES_01->SetMaximum(0.12);
  else h_JES_01->SetMaximum(0.12);
  ...
  TLegend* leg1 = new TLegend(0.63, 0.54, 0.92, 0.70);
  ...
  c3->SaveAs(Form("out_figs/threefile_nofit_%s_%s.pdf",jetE.c_str(),vtxType.c_str())); 
  return;
}
////////////////////////////////////////
