...
void minuit_truthjet_alframe_py8jet(string sampleType = "py8Jet",
...
{  
  ...
  static Double_t vstart[2] = {1.5, 1.5}; //staring values
  static Double_t step[2] = {0.01, 0.01}; //step
  gMinuit->mnparm(0, "cemc_scale", vstart[0], step[0], 1.001,5.0,ierflg);
  gMinuit->mnparm(1, "ohcal_scale", vstart[1], step[1], 1.001,5.0,ierflg);
