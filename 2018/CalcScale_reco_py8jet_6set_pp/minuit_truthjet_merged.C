...
void minuit_truthjet_merged(string sampleType = "QCDJet",
                              	string ihcalType = "Al",
                              	string jetE = "20GeV",
                              	string note = "R04",
                              	int initfile=0,
...
{  
  ...
  c1->SaveAs(Form("minuit_truthjet_merged/%d_%d_%s_%s_%s_%s.pdf",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str()));
  ...
  c2->SaveAs(Form("minuit_truthjet_merged/%d_%d_%s_%s_%s_%s_v2.pdf",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str()));
