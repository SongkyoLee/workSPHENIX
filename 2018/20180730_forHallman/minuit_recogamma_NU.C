...
void minuit_recogamma(string sampleType = "GammaJet",
                              	string ihcalType = "Al",
                              	string jetE = "50GeV",
                              	string note = "R02",
                              	int initfile=0,
...
{  
  ...
  gMinuit->mnparm(1, "ihcal_scale", vstart[1], step[1], 2,10,ierflg); //lower=2 upper=10
  ...
  c1->SaveAs(Form("minuit_recogamma/%d_%d_%s_%s_%s_%s.pdf",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str()));
  ...
  c2->SaveAs(Form("minuit_recogamma/%d_%d_%s_%s_%s_%s_v2.pdf",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str()));
