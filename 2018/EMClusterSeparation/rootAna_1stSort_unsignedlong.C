...
unsigned long this_true_event=1; //start from event 1!! 
...
unsigned long this_reco_event=1; //start from event 1!! 
int reco_n;
...
void rootAna_1stSort(string label = "QCDJet20GeVR04_Al",int initfile=0,int endfile = 200, bool doetopcut=true, bool dodphicut=true)
{
  ...
  ///////////////////////////////////////////////////////////////////////////
  unsigned long true_count=0;
  unsigned long reco_count=0;
  ...
  for(int j=initfile; j<endfile; j++){
    ...
    ///////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////
    unsigned long prev_truthevent=j*50+1;
    true_n=0;
    ...
    ///////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////
    unsigned long prev_towerevent=j*50+1;
    reco_n=0;
