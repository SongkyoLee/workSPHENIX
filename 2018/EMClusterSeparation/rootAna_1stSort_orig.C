...
void rootAna_1stSort(string label = "GammaJet20GeV_Al",int initfile=0,int endfile = 200, bool doetopcut=true, bool dodphicut=true)
{
  ...
  else if (label.compare("QCDJet20GeV_SS310")==0){ sampleType = "QCDJet"; ihcalType = "SS310"; jetE="20GeV"; note = "vtx0"; }
  else if (label.compare("QCDJet30GeV_SS310")==0){ sampleType = "QCDJet"; ihcalType = "SS310"; jetE="30GeV"; note = "vtx0"; }
  else if (label.compare("QCDJet40GeV_SS310")==0){ sampleType = "QCDJet"; ihcalType = "SS310"; jetE="40GeV"; note = "vtx0"; }
  else if (label.compare("QCDJet50GeV_SS310")==0){ sampleType = "QCDJet"; ihcalType = "SS310"; jetE="50GeV"; note = "vtx0"; }
  else if (label.compare("QCDJet20GeV_Al")==0){ sampleType = "QCDJet"; ihcalType = "Al"; jetE="20GeV"; note = "vtx0"; }
  else if (label.compare("QCDJet30GeV_Al")==0){ sampleType = "QCDJet"; ihcalType = "Al"; jetE="30GeV"; note = "vtx0"; }
  else if (label.compare("QCDJet40GeV_Al")==0){ sampleType = "QCDJet"; ihcalType = "Al"; jetE="40GeV"; note = "vtx0"; }
  else if (label.compare("QCDJet50GeV_Al")==0){ sampleType = "QCDJet"; ihcalType = "Al"; jetE="50GeV"; note = "vtx0"; }
  else if (label.compare("QCDJet20GeV_Alframe")==0){ sampleType = "QCDJet"; ihcalType = "Alframe"; jetE="20GeV"; note = "vtx0"; }
  else if (label.compare("QCDJet30GeV_Alframe")==0){ sampleType = "QCDJet"; ihcalType = "Alframe"; jetE="30GeV"; note = "vtx0"; }
  else if (label.compare("QCDJet40GeV_Alframe")==0){ sampleType = "QCDJet"; ihcalType = "Alframe"; jetE="40GeV"; note = "vtx0"; }
  else if (label.compare("QCDJet50GeV_Alframe")==0){ sampleType = "QCDJet"; ihcalType = "Alframe"; jetE="50GeV"; note = "vtx0"; }
