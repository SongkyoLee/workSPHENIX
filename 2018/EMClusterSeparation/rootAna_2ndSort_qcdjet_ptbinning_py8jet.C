...
void rootAna_2ndSort_qcdjet_ptbinning_py8jet(string sampleType = "py8Jet",
...
//  lumi[3] = 6067.85*(400*50)/(276*200);
  ...
  //for (int ievt=0; ievt<50; ievt++){ 
    ...
    for (int itrue=0; itrue<true_n; itrue++){
      ...
      if (jetOutE.compare("50GeV")==0){ if (!(true_pt[itrue] > 50 && true_pt[itrue] <60)) continue;}
      if (jetOutE.compare("60GeV")==0){ if (!(true_pt[itrue] > 60 && true_pt[itrue] <70)) continue;}
      if (jetOutE.compare("70GeV")==0){ if (!(true_pt[itrue] > 70 && true_pt[itrue] <80)) continue;}
