...
*/
      ...
      for (int icc =0; icc < tmp_track_p.size(); icc ++) {
        ...
        if ( isetop && isdphi ) {
          ...
          tmp_calib_clcemc_had.SetPtEtaPhiM(tmp_pt.at(icc), tmp_eta.at(icc), tmp_phi.at(icc), 0);
      ...
      for (int icemchad =0; icemchad < calib_clcemc_had.size(); icemchad ++) {
        tmpsum += calib_clcemc_had.at(icemchad).E();
      }
      
      if (towerevent==1) {
        cout << "clcemc_had_n = " << clcemc_had_n << endl;
        cout << "clcemc_hadsum = " << clcemc_hadsum << endl;
        cout << "calib_clcemc_had.size() = " <<  calib_clcemc_had.size() << endl;
