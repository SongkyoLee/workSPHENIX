...
void minuit_recogamma_alframe(string sampleType = "GammaJet",
...
{  
  ...
  c1->SaveAs(Form("minuit_recogamma/%d_%d_%s_%s_%s.pdf",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str()));
  ...
  c1->SaveAs(Form("minuit_recogamma/%d_%d_%s_%s_%s_v2.pdf",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str()));
