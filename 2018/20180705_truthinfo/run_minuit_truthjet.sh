...
foreach ihcal (Alframe)
  foreach note (R02 R04)
    foreach energy (20GeV 30GeV 40GeV 50GeV)
      root -l -b -q minuit_truthjet_alframe_usingAl.C\(\"QCDJet\",\"$ihcal\",\"$energy\",\"$note\",$initfile,$endfile,true,true\) >&logs/log_truthjet_$initfile\_$endfile\_$energy\_$ihcal\_$note&
    end
  end
end
