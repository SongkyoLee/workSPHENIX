void draw_SFvsE_SS310(string inputType="final_qcd"){
  ...
  if (infile_cemc.is_open()){
    while( getline (infile_cemc,szcemc) ) {
      ...
      if (icemc <nEBin){
        ...
        cemc01[icemc-1*nEBin] = tmpcemc;
      } else if (icemc < 3*nEBin){
        cemc02[icemc-2*nEBin] = tmpcemc;
      } else if (icemc < 4*nEBin){
        cemc03[icemc-3*nEBin] = tmpcemc;
      } else if (icemc < 5*nEBin){
        cemc04[icemc-4*nEBin] = tmpcemc;
      } else if (icemc < 6*nEBin){
        cemc05[icemc-5*nEBin] = tmpcemc;
  ...
  if (infile_ihcal.is_open()){
    while( getline (infile_ihcal,szihcal) ) {
      ...
      if (iihcal <nEBin){
        ...
        ihcal01[iihcal-1*nEBin] = tmpihcal;
      } else if (iihcal < 3*nEBin){
        ihcal02[iihcal-2*nEBin] = tmpihcal;
      } else if (iihcal < 4*nEBin){
        ihcal03[iihcal-3*nEBin] = tmpihcal;
      } else if (iihcal < 5*nEBin){
        ihcal04[iihcal-4*nEBin] = tmpihcal;
      } else if (iihcal < 6*nEBin){
        ihcal05[iihcal-5*nEBin] = tmpihcal;
  ...
  if (infile_ohcal.is_open()){
    while( getline (infile_ohcal,szohcal) ) {
      ...
      if (iohcal <nEBin){
        ...
        ohcal01[iohcal-1*nEBin] = tmpohcal;
      } else if (iohcal < 3*nEBin){
        ohcal02[iohcal-2*nEBin] = tmpohcal;
      } else if (iohcal < 4*nEBin){
        ohcal03[iohcal-3*nEBin] = tmpohcal;
      } else if (iohcal < 5*nEBin){
        ohcal04[iohcal-4*nEBin] = tmpohcal;
      } else if (iohcal < 6*nEBin){
        ohcal05[iohcal-5*nEBin] = tmpohcal;
  ...
  c_sf->SaveAs(Form("outvsE/SFvsE_SS310_%s.pdf",inputType.c_str()));
