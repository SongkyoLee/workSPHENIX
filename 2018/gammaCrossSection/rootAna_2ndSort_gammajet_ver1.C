...
void rootAna_2ndSort_gammajet_ver1(string sampleType = "GammaJet",
                              ...
                              bool dodphicut=false)
{
  ...
  //////////////////////////////////////////////////////////////////////////// 
  //// write new tree
  string foutname = Form("./2ndSortedRootFiles/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_doetopcut%d_dodphicut%d_ver1.root",initfile,endfile,sampleType.c_str(),jetOutE.c_str(),ihcalType.c_str(),(int)doetopcut,(int)dodphicut);
