...
void rootAna_2ndSort_gammajet_ver4(string sampleType = "GammaJet",
                              ...
                              bool dodphicut=true)
{
  ...
  //// write new tree
  string foutname = Form("./2ndSortedRootFiles/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_doetopcut%d_dodphicut%d_ver4.root",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),(int)doetopcut,(int)dodphicut);
  ...
  //for (int ievt=0; ievt<10; ievt++){ 
    ...
    if (true_gamma_e < 20) continue; //only to gamma
