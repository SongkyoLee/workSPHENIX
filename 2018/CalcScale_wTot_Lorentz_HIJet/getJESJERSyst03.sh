...
if (-d txt_jet_syst03) then
  echo "N.B. txt_jet_syst03 dir already exits! It will be removed and newly created!"
  rm -r txt_jet_syst03
endif
mkdir txt_jet_syst03
  ...
  foreach note (04fmR02 04fmR04 48fmR02 48fmR04)
    ...
    foreach method (before truthjet_hi)
      foreach energy (20GeV 30GeV 40GeV 50GeV)
        ...
        awk '{for (I=1;I<=NF;I++) if ($I == "jes_mean") {print $(I+2)};}' logs_syst03/log_final_qcd_$method\_$initfile\_$endfile\_$energy\_$ihcal\_$note >>txt_jet_syst03/jes_$method\_$ihcal\_$note.out 
        awk '{for (I=1;I<=NF;I++) if ($I == "jes_sig/mean") {print $(I+2)};}' logs_syst03/log_final_qcd_$method\_$initfile\_$endfile\_$energy\_$ihcal\_$note >>txt_jet_syst03/jer_$method\_$ihcal\_$note.out 
      end
    end
  end
end
