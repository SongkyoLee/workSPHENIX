...
void final_qcdjet_Syst05(string sampleType = "HIJet",
                              string ihcalType = "Al",
                              string jetE = "20GeV",
                              string note = "48fmR02",
                              int initfile=0,
...
//  palette->SetX2NDC(1-margin*3);
  ...
  ////////////////////////////////////////
  if (total_sf !=1) {
    c1->SaveAs(Form("outFinal%sSyst05/final2D_%s_%s_%s_%s_%.0f_%.0f_%.0f_wTot%.0f.pdf",ihcalType.c_str(),sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str(),100*cemc_sf,100*ihcal_sf,100*ohcal_sf,100*total_sf));
  } else {
    c1->SaveAs(Form("outFinal%sSyst05/final2D_%s_%s_%s_%s_%.0f_%.0f_%.0f.pdf",ihcalType.c_str(),sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str(),100*cemc_sf,100*ihcal_sf,100*ohcal_sf));
  }  
  ...
  if (total_sf !=1) {
    c2->SaveAs(Form("outFinal%sSyst05/final1D_%s_%s_%s_%s_%.0f_%.0f_%.0f_wTot%.0f.pdf",ihcalType.c_str(),sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str(),100*cemc_sf,100*ihcal_sf,100*ohcal_sf,100*total_sf));
  } else {
    c2->SaveAs(Form("outFinal%sSyst05/final1D_%s_%s_%s_%s_%.0f_%.0f_%.0f.pdf",ihcalType.c_str(),sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str(),100*cemc_sf,100*ihcal_sf,100*ohcal_sf));
  }
  ...
  //cout << "jer_sig = " << sig_jer << endl;
	...
	TFile* fout;
  //fout = new TFile(Form("outFinal%sSyst05/final_%s_%s_%s_%s_%.0f_%.0f_%.0f.root",ihcalType.c_str(),sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str(),100*cemc_sf,100*ihcal_sf,100*ohcal_sf),"RECREATE");
  if (cemc_sf==1 && ihcal_sf==1 && ohcal_sf==1) { 
    fout = new TFile(Form("outFinal%sSyst05/final_%s_%s_%s_%s_before.root",ihcalType.c_str(),sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str()),"RECREATE"); 
  } else { 
    if (total_sf!=1){
      fout = new TFile(Form("outFinal%sSyst05/final_%s_%s_%s_%s_truthjet_wTot.root",ihcalType.c_str(),sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str()),"RECREATE"); //tmp 
    } else {
      fout = new TFile(Form("outFinal%sSyst05/final_%s_%s_%s_%s_truthjet.root",ihcalType.c_str(),sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str()),"RECREATE"); //tmp
    }   
  }
