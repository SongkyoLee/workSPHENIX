void draw_JESJERvsE_overlay_wTot(string note="R02"){
  ...
  infile_jesSS310Before.open(Form("txt_jet_wTot/jes_before_SS310_%s.out",note.c_str()));
  ijes_SS310=0;
  ...
  for (int im=0; im<nMeth; im++){
    infile_jesSS310After[im].open(Form("txt_jet_wTot/jes_%s_SS310_%s.out",szMeth[im].c_str(),note.c_str()));
    ijes_SS310=0;
  ...
  infile_jesAlBefore.open(Form("txt_jet_wTot/jes_before_Al_%s.out",note.c_str()));
  ijes_Al=0;
  ...
  for (int im=0; im<nMeth; im++){
    infile_jesAlAfter[im].open(Form("txt_jet_wTot/jes_%s_Al_%s.out",szMeth[im].c_str(),note.c_str()));
    ijes_Al=0;
  ...
  infile_jesAlframeBefore.open(Form("txt_jet_wTot/jes_before_Alframe_%s.out",note.c_str()));
  ijes_Alframe=0;
  ...
  for (int im=0; im<nMeth; im++){
    infile_jesAlframeAfter[im].open(Form("txt_jet_wTot/jes_%s_Alframe_%s.out",szMeth[im].c_str(),note.c_str()));
    ijes_Alframe=0;
...
*/
  ...
  c_JES->SaveAs(Form("outvsE_wTot/JESvsE_%s.pdf",note.c_str()));
  ///////////////////////////////////////
  ...
  infile_jerSS310Before.open(Form("txt_jet_wTot/jer_before_SS310_%s.out",note.c_str()));
  ijer_SS310=0;
  ...
  for (int im=0; im<nMeth; im++){
    infile_jerSS310After[im].open(Form("txt_jet_wTot/jer_%s_SS310_%s.out",szMeth[im].c_str(),note.c_str()));
    ijer_SS310=0;
  ...
  infile_jerAlBefore.open(Form("txt_jet_wTot/jer_before_Al_%s.out",note.c_str()));
  ijer_Al=0;
  ...
  for (int im=0; im<nMeth; im++){
    infile_jerAlAfter[im].open(Form("txt_jet_wTot/jer_%s_Al_%s.out",szMeth[im].c_str(),note.c_str()));
    ijer_Al=0;
  ...
  infile_jerAlframeBefore.open(Form("txt_jet_wTot/jer_before_Alframe_%s.out",note.c_str()));
  ijer_Alframe=0;
  ...
  for (int im=0; im<nMeth; im++){
    infile_jerAlframeAfter[im].open(Form("txt_jet_wTot/jer_%s_Alframe_%s.out",szMeth[im].c_str(),note.c_str()));
    ijer_Alframe=0;
...
*/
  ...
  c_JER->SaveAs(Form("outvsE_wTot/JERvsE_%s.pdf",note.c_str()));
  ///////////////////////////////////////
  
  ///////////////////////////////////////
  
  TFile* fout =  new TFile(Form("outvsE_wTot/JESvsE_%s.root",note.c_str()),"RECREATE");
  fout->cd();
