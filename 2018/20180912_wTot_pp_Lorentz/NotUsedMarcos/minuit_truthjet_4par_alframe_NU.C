...
void minuit_truthjet_4par_alframe(string sampleType = "QCDJet",
...
{  
  ...
  gMinuit->mnparm(2, "cemcem_scale", vstart[2], step[2], 1,10,ierflg);
  ...
  gMinuit->GetParameter(2,cemcEmScale,cemcEmScaleErr);
  ...
  for (int ievt=0; ievt <nevt; ievt++){
    ...
    reco_jet_caliE = cemcEmScale*reco_jet_clcemc_emEsum + cemcScale*reco_jet_clcemc_hadEsum + ohcalScale*reco_jet_ohcalEsum;
