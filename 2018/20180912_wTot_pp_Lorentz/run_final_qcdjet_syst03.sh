  ...
  foreach note (R02 R04)
    ...
    #foreach method (before truthjet truthjet_2par)
      foreach energy (20GeV 30GeV 40GeV 50GeV)
        ...
        root -l -b -q final_qcdjet_Syst03.C\(\"QCDJet\",\"$ihcal\",\"$energy\",\"$note\",$initfile,$endfile,1.00,$thiscemc,$thisihcal,$thisohcal,true,true\) >&logs_syst03/log_final_qcd_$method\_$initfile\_$endfile\_$energy\_$ihcal\_$note&
        sleep 1s
      end  
    end  
  end  
