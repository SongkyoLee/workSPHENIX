                              ...
                              bool doscale=false)
{
  ...
  //string foutname = Form("./2ndSortedRootFilesPtBinning/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_%s_doetopcut%d_dodphicut%d.root",initfile,endfile,sampleType.c_str(),jetOutE.c_str(),ihcalType.c_str(),note.c_str(),(int)doetopcut,(int)dodphicut);
  string foutname = Form("./2ndSortedRootFilesLorentzPtBinning/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_%s_doetopcut%d_dodphicut%d_doscale%d.root",initfile,endfile,sampleType.c_str(),jetOutE.c_str(),ihcalType.c_str(),note.c_str(),(int)doetopcut,(int)dodphicut,(int)doscale);
