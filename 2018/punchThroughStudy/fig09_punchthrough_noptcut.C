...
void fig09_punchthrough_noptcut(bool isHighz = false,
                              int isOpt = 10,
                              ...
                              bool dodphicut=true)
{
  ...
  string fname01;
  if (isHighz) { fname01 = Form("./2ndSortedRootFiles_highz/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_doetopcut%d_dodphicut%d_noptcut_highz.root",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),(int)doetopcut,(int)dodphicut); }
  else { fname01 = Form("./2ndSortedRootFiles_highz/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_doetopcut%d_dodphicut%d_noptcut_allz.root",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),(int)doetopcut,(int)dodphicut); }
  ...
  TH1D* h_JER_01 = new TH1D("h_JER_01",";(Jet E_{Reco}-Jet E_{Truth}) / Jet E_{Reco};Normalized counts",100,-1,1);
  h_JES_01->Sumw2();
  h_JER_01->Sumw2();
...
//  tf_JER_01->Draw("same");
  ...
  ihcalType = "Alframe";
  string fname02;
  if (isHighz) { fname02 = Form("./2ndSortedRootFiles_highz/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_doetopcut%d_dodphicut%d_noptcut_highz.root",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),(int)doetopcut,(int)dodphicut); }
  else { fname02 = Form("./2ndSortedRootFiles_highz/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_doetopcut%d_dodphicut%d_noptcut_allz.root",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),(int)doetopcut,(int)dodphicut); }
...
//  tf_JER_02->Draw("same");
  ...
  //h_JES_01->SetMinimum(0.00001);

  h_JES_01->SetMinimum(0.00005);
  h_JES_01->SetMaximum(1);
  h_JES_01->Draw("hist");
  ...
  if (isHighz) {
    c3->SaveAs(Form("out_figs/hcal_punch_noptcut_highz_isOpt%d.pdf",isOpt));
  }else {
    c3->SaveAs(Form("out_figs/hcal_punch_noptcut_isOpt%d.pdf",isOpt));
  }
