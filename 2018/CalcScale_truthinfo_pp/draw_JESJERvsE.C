void draw_JESJERvsE(string ihcalType="Al", string note="R02"){
  ...
  leg1->AddEntry(gjesAl[0],"After calib. old","lp");
  leg1->AddEntry(gjesAl[1],"After calib. new","lp");
  leg1->Draw();
  ...
  else if (ihcalType.compare("SS310")==0) { latex->DrawLatex(0.2,0.77,"Instrumented Steel");  }
