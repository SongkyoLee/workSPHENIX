                              ...
                              bool dodphicut=true)
{
  ...
  gStyle->SetOptFit(0);
  //gStyle->SetOptFit(1);
  prof_IHAsymm->SetMarkerColor(kGray+3);
  prof_IHAsymm->SetLineColor(kGray+3);
...
//  palette->SetX2NDC(1-margin*3);
  ...
  gStyle->SetOptFit(0);
  prof_EHAsymm->SetMarkerColor(kGray+3);
  prof_EHAsymm->SetLineColor(kGray+3);
  ...
  gStyle->SetOptFit(0);
  prof_totEHAsymm->SetMarkerColor(kGray+3);
  prof_totEHAsymm->SetLineColor(kGray+3);
  ...
  gStyle->SetOptFit(0);
  prof_emfrac->SetMarkerColor(kGray+3);
  prof_emfrac->SetLineColor(kGray+3);
