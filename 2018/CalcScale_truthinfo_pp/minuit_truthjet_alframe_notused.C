...
////  out_tree->SetBranchAddress("reco_gamma_cemcEsum",&reco_gamma_cemcEsum);
  ...
  for (int ievt=0; ievt <nevt; ievt++){
    ...
    h_origRESRecoGamma->Fill( (reco_jet_origE-true_jet_e)/true_jet_e );    
    h_emfrac_origRESRecoGamma->Fill( true_jet_emfrac, (reco_jet_origE-true_jet_e)/true_jet_e );
    h_emfrac_origJESRecoGamma->Fill( true_jet_emfrac, reco_jet_origE/true_jet_e );
  ...
  for (int ievt=0; ievt <nevt; ievt++){
    ...
    h_RESRecoGamma->Fill( (reco_jet_caliE-true_jet_e)/true_jet_e );    
    h_emfrac_RESRecoGamma->Fill( true_jet_emfrac, (reco_jet_caliE-true_jet_e)/true_jet_e );
    h_emfrac_JESRecoGamma->Fill( true_jet_emfrac, reco_jet_caliE/true_jet_e );
  ...
  c1->SaveAs(Form("minuit_truthjet/%d_%d_%s_%s_%s.pdf",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str()));
  ...
  c1->SaveAs(Form("minuit_truthjet/%d_%d_%s_%s_%s_v2.pdf",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str()));
