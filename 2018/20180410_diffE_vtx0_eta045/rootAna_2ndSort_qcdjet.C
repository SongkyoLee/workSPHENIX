...
/*
      else if (jetOutE.compare("20GeV")==0){ if (!(true_e[itrue] > 20 && true_e[itrue] <25)) continue;}
      else if (jetOutE.compare("25GeV")==0){ if (!(true_e[itrue] > 25 && true_e[itrue] <30)) continue;}
      else if (jetOutE.compare("30GeV")==0){ if (!(true_e[itrue] > 30 && true_e[itrue] <35)) continue;}
      else if (jetOutE.compare("35GeV")==0){ if (!(true_e[itrue] > 35 && true_e[itrue] <40)) continue;}
      else if (jetOutE.compare("40GeV")==0){ if (!(true_e[itrue] > 40 && true_e[itrue] <45)) continue;}
      else if (jetOutE.compare("45GeV")==0){ if (!(true_e[itrue] > 45 && true_e[itrue] <50)) continue;}
      else if (jetOutE.compare("50GeV")==0){ if (!(true_e[itrue] > 50 && true_e[itrue] <55)) continue;}
      else if (jetOutE.compare("55GeV")==0){ if (!(true_e[itrue] > 55 && true_e[itrue] <60)) continue;}
*/
