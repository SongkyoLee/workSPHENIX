                              ...
                              bool dodphicut=false)
{
  ...
  for (int ievt=0; ievt<true_tree->GetEntries(); ievt++){ 
    ...
    //// *** reco jet e range (cut on reco)
		if (jetOutE.compare("allGeV")==0){ if (!(reco_gamma_e > 20)) continue; }
    else if (jetOutE.compare("20GeV")==0){ if (!(reco_gamma_e > 20 && reco_gamma_e <30)) continue; }
    else if (jetOutE.compare("30GeV")==0){ if (!(reco_gamma_e > 30 && reco_gamma_e <40)) continue; }
    else if (jetOutE.compare("40GeV")==0){ if (!(reco_gamma_e > 40 && reco_gamma_e <50)) continue; }
    else if (jetOutE.compare("50GeV")==0){ if (!(reco_gamma_e > 50 && reco_gamma_e <60)) continue; }
/*
		if (jetOutE.compare("allGeV")==0){ if (!(reco_gamma_e > 20)) continue; }
    else if (jetOutE.compare("20GeV")==0){ if (!(reco_gamma_e > 20 && reco_gamma_e <25)) continue; }
    else if (jetOutE.compare("25GeV")==0){ if (!(reco_gamma_e > 25 && reco_gamma_e <30)) continue; } 
    else if (jetOutE.compare("30GeV")==0){ if (!(reco_gamma_e > 30 && reco_gamma_e <35)) continue; }
    else if (jetOutE.compare("35GeV")==0){ if (!(reco_gamma_e > 35 && reco_gamma_e <40)) continue; }
    else if (jetOutE.compare("40GeV")==0){ if (!(reco_gamma_e > 40 && reco_gamma_e <45)) continue; }
    else if (jetOutE.compare("45GeV")==0){ if (!(reco_gamma_e > 45 && reco_gamma_e <50)) continue; }
    else if (jetOutE.compare("50GeV")==0){ if (!(reco_gamma_e > 50 && reco_gamma_e <55)) continue; }
    else if (jetOutE.compare("55GeV")==0){ if (!(reco_gamma_e > 55 && reco_gamma_e <60)) continue; }
*/
