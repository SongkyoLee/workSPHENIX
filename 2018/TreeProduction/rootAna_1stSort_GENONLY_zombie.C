...
void rootAna_1stSort_GENONLY_zombie(string label = "GENONLY_QCDJet20GeVR04_noTreeCut",int initfile=0,int endfile = 300, bool doetopcut=true, bool dodphicut=true)
{
  ...
  if (label.compare("GENONLY_QCDJet20GeVR04_noTreeCut")==0){ sampleType = "QCDJet"; ihcalType = "noTreeCut"; jetE="20GeV"; note = "GENONLYR04"; }
  else if (label.compare("GENONLY_QCDJet30GeVR04_noTreeCut")==0){ sampleType = "QCDJet"; ihcalType = "noTreeCut"; jetE="30GeV"; note = "GENONLYR04"; }
  else if (label.compare("GENONLY_QCDJet40GeVR04_noTreeCut")==0){ sampleType = "QCDJet"; ihcalType = "noTreeCut"; jetE="40GeV"; note = "GENONLYR04"; }
  else if (label.compare("GENONLY_QCDJet50GeVR04_noTreeCut")==0){ sampleType = "QCDJet"; ihcalType = "noTreeCut"; jetE="50GeV"; note = "GENONLYR04"; }
  else { cout << "KYO WARNING: select proper ihcal type"<<endl; return; }

  //// write new tree 
  string foutname = Form("./sortedRootFiles/GENONLY_sorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_%s_doetopcut%d_dodphicut%d.root",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),note.c_str(),(int)doetopcut,(int)dodphicut);
...
*/
  ...
  for(int j=initfile; j<endfile; j++){
    ...
    if (sampleType.compare("QCDJet")==0) {
      if (note.compare("GENONLYR04")==0) { fname = Form("./out_%s/G4sPHENIX_%d.root",label.c_str(),); }
    ...
    if(fin->isZombie()) { cout << j<<"th file zombie " <<endl; return;}
