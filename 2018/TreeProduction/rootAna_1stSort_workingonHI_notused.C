...
void rootAna_1stSort(string label = "HIJet20GeV48fm_Al",int initfile=0,int endfile = 200, bool doetopcut=false, bool dodphicut=false)
{
  ...
  if (label.compare("HIJet20GeV48fm_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "48fm"; }
  else if (label.compare("HIJet30GeV48fm_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "48fm"; }
  else if (label.compare("HIJet40GeV48fm_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "48fm"; }
  else if (label.compare("HIJet50GeV48fm_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "48fm"; }
  else if (label.compare("HIJet20GeV04fm_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "04fm"; }
  else if (label.compare("HIJet30GeV04fm_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "04fm"; }
  else if (label.compare("HIJet40GeV04fm_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "04fm"; }
  else if (label.compare("HIJet50GeV04fm_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "04fm"; }
  else if (label.compare("HIJet20GeV48fmR02_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "48fmR02"; }
  else if (label.compare("HIJet30GeV48fmR02_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "48fmR02"; }
  else if (label.compare("HIJet40GeV48fmR02_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "48fmR02"; }
  else if (label.compare("HIJet50GeV48fmR02_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "48fmR02"; }
  else if (label.compare("HIJet20GeV04fmR02_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "04fmR02"; }
  else if (label.compare("HIJet30GeV04fmR02_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "04fmR02"; }
  else if (label.compare("HIJet40GeV04fmR02_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "04fmR02"; }
  else if (label.compare("HIJet50GeV04fmR02_Al")==0){ sampleType = "HIJet"; ihcalType = "Al"; jetE="20GeV"; note = "04fmR02"; }
  else if (label.compare("py8GammaJet_vtx10gaus_SS310")==0){ sampleType = "GammaJet"; ihcalType = "SS310"; jetE="allGeV"; note = "vtx10gaus"; }
  ...
  else if (label.compare("GammaJet20GeV_SS310")==0){ sampleType = "GammaJet"; ihcalType = "SS310"; jetE="20GeV"; note = "R04"; }
  else if (label.compare("GammaJet30GeV_SS310")==0){ sampleType = "GammaJet"; ihcalType = "SS310"; jetE="30GeV"; note = "R04"; }
  else if (label.compare("GammaJet40GeV_SS310")==0){ sampleType = "GammaJet"; ihcalType = "SS310"; jetE="40GeV"; note = "R04"; }
  else if (label.compare("GammaJet50GeV_SS310")==0){ sampleType = "GammaJet"; ihcalType = "SS310"; jetE="50GeV"; note = "R04"; }
  else if (label.compare("GammaJet20GeV_Al")==0){ sampleType = "GammaJet"; ihcalType = "Al"; jetE="20GeV"; note = "R04"; }
  else if (label.compare("GammaJet30GeV_Al")==0){ sampleType = "GammaJet"; ihcalType = "Al"; jetE="30GeV"; note = "R04"; }
  else if (label.compare("GammaJet40GeV_Al")==0){ sampleType = "GammaJet"; ihcalType = "Al"; jetE="40GeV"; note = "R04"; }
  else if (label.compare("GammaJet50GeV_Al")==0){ sampleType = "GammaJet"; ihcalType = "Al"; jetE="50GeV"; note = "R04"; }
  else if (label.compare("GammaJet20GeV_Alframe")==0){ sampleType = "GammaJet"; ihcalType = "Alframe"; jetE="20GeV"; note = "R04"; }
  else if (label.compare("GammaJet30GeV_Alframe")==0){ sampleType = "GammaJet"; ihcalType = "Alframe"; jetE="30GeV"; note = "R04"; }
  else if (label.compare("GammaJet40GeV_Alframe")==0){ sampleType = "GammaJet"; ihcalType = "Alframe"; jetE="40GeV"; note = "R04"; }
  else if (label.compare("GammaJet50GeV_Alframe")==0){ sampleType = "GammaJet"; ihcalType = "Alframe"; jetE="50GeV"; note = "R04"; }
  else if (label.compare("QCDJet20GeV_SS310")==0){ sampleType = "QCDJet"; ihcalType = "SS310"; jetE="20GeV"; note = "R04"; }
  else if (label.compare("QCDJet30GeV_SS310")==0){ sampleType = "QCDJet"; ihcalType = "SS310"; jetE="30GeV"; note = "R04"; }
  else if (label.compare("QCDJet40GeV_SS310")==0){ sampleType = "QCDJet"; ihcalType = "SS310"; jetE="40GeV"; note = "R04"; }
  else if (label.compare("QCDJet50GeV_SS310")==0){ sampleType = "QCDJet"; ihcalType = "SS310"; jetE="50GeV"; note = "R04"; }
  else if (label.compare("QCDJet20GeV_Al")==0){ sampleType = "QCDJet"; ihcalType = "Al"; jetE="20GeV"; note = "R04"; }
  else if (label.compare("QCDJet30GeV_Al")==0){ sampleType = "QCDJet"; ihcalType = "Al"; jetE="30GeV"; note = "R04"; }
  else if (label.compare("QCDJet40GeV_Al")==0){ sampleType = "QCDJet"; ihcalType = "Al"; jetE="40GeV"; note = "R04"; }
  else if (label.compare("QCDJet50GeV_Al")==0){ sampleType = "QCDJet"; ihcalType = "Al"; jetE="50GeV"; note = "R04"; }
  else if (label.compare("QCDJet20GeV_Alframe")==0){ sampleType = "QCDJet"; ihcalType = "Alframe"; jetE="20GeV"; note = "R04"; }
  else if (label.compare("QCDJet30GeV_Alframe")==0){ sampleType = "QCDJet"; ihcalType = "Alframe"; jetE="30GeV"; note = "R04"; }
  else if (label.compare("QCDJet40GeV_Alframe")==0){ sampleType = "QCDJet"; ihcalType = "Alframe"; jetE="40GeV"; note = "R04"; }
  else if (label.compare("QCDJet50GeV_Alframe")==0){ sampleType = "QCDJet"; ihcalType = "Alframe"; jetE="50GeV"; note = "R04"; }
...
*/
  ...
  for(int j=initfile; j<endfile; j++){
    ...
    string fname;
    if (sampleType.compare("HIJet")==0) {
      if (note.compare("04fm")==0 || note.compare("48fm")==0 || note.compare("04fmR02")==0 || note.compare("48fmR02")==0) { 
        if (jetE.compare("20GeV")==0 || jetE.compare("30GeV")==0 || jetE.compare("40GeV")==0 || jetE.compare("20GeV")==0 ){
          fname = Form("./out_%s/QCD10GeV_R04jet20GeVeta0p45_G4sPHENIX_%d.root",label.c_str(),j);
        }
      }
    }
    else if (sampleType.compare("GammaJet")==0) {
      ...
      if (note.compare("R04")==0) {
        if (jetE.compare("20GeV")==0) { fname = Form("./out_%s/QCD15GeV_R04jet20GeVeta0p6_G4sPHENIX_File_%d.root",label.c_str(),j); }
        else if (jetE.compare("30GeV")==0) { fname = Form("./out_%s/QCD25GeV_R04jet30GeVeta0p6_G4sPHENIX_File_%d.root",label.c_str(),j); }
        else if (jetE.compare("40GeV")==0) { fname = Form("./out_%s/QCD30GeV_R04jet40GeVeta0p6_G4sPHENIX_File_%d.root",label.c_str(),j); }
        else if (jetE.compare("50GeV")==0) { fname = Form("./out_%s/QCD35GeV_R04jet50GeVeta0p45_G4sPHENIX_%d.root",label.c_str(),j); } //now
        else { cout << "WARNING! wrong file selection" << endl; return;  }
      }
      else if (note.compare("vtx0")==0) {
        if (jetE.compare("20GeV")==0) { fname = Form("./out_%s/QCD15GeV_R04jet20GeVeta0p6_G4sPHENIX_File_%d.root",label.c_str(),j); }
        else if (jetE.compare("30GeV")==0) { fname = Form("./out_%s/QCD25GeV_R04jet30GeVeta0p6_G4sPHENIX_File_%d.root",label.c_str(),j); }
        else if (jetE.compare("40GeV")==0) { fname = Form("./out_%s/QCD30GeV_R04jet40GeVeta0p6_G4sPHENIX_File_%d.root",label.c_str(),j); }
        else if (jetE.compare("50GeV")==0) { fname = Form("./out_%s/DVP_QCD35_10k_G4sPHENIX_File_%d.root",label.c_str(),j); }
        else { cout << "WARNING! wrong file selection" << endl; return;  }
      }
...
//    cout << "truthjet4_tree = " << truthjet4_tree << endl;
//    cout << "towerjet4_tree = " << towerjet4_tree << endl;
...
*/
    ...
    for (int itrue=0; itrue<truthjet4_tree->GetEntries(); itrue++){
      ...
      for (int icons =0; icons < truthjet4_cons_n; icons ++) {
        ...
        else { h_pt_other->Fill(truthjet4_cons_pt->at(icons)); }
      } 
      ...
      true_n++;
      if (true_n%100==0) cout << "true_n = " << true_n << endl;
    } // EOL over truth jet
    ...
    for (int ireco=0; ireco<towerjet4_tree->GetEntries(); ireco++){
      ...
      for (int icemc =0; icemc < towerjet4_cemc_n; icemc ++) {
        //test
        //if (towerjet4_cemc_dR->at(icemc) < 0.4) cemc_sum += towerjet4_cemc_e->at(icemc); 
        cemc_sum += towerjet4_cemc_e->at(icemc); 
      } 
      for (int iihcal =0; iihcal < towerjet4_ihcal_n; iihcal ++) {
        //if (towerjet4_ihcal_dR->at(iihcal) < 0.4) ihcal_sum += towerjet4_ihcal_e->at(iihcal); 
        ihcal_sum += towerjet4_ihcal_e->at(iihcal); 
      } 
      for (int iohcal =0; iohcal < towerjet4_ohcal_n; iohcal ++) {
        //if (towerjet4_ohcal_dR->at(iohcal) < 0.4) ohcal_sum += towerjet4_ohcal_e->at(iohcal); 
