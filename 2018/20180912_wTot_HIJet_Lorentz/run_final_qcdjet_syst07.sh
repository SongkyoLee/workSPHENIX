  ...
  foreach note (04fmR02 04fmR04 48fmR02 48fmR04)
    ...
    foreach method (before truthjet_hi)
      foreach energy (20GeV 30GeV 40GeV 50GeV)
        ...
        root -l -b -q final_qcdjet_Syst07.C\(\"HIJet\",\"$ihcal\",\"$energy\",\"$note\",$initfile,$endfile,1.00,$thiscemc,$thisihcal,$thisohcal,false,false\) >&logs_syst07/log_final_qcd_$method\_$initfile\_$endfile\_$energy\_$ihcal\_$note&
        sleep 1s
      end  
    end  
  end  
