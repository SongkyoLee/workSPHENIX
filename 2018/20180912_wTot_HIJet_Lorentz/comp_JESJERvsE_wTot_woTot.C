void comp_JESJERvsE_wTot_woTot(string ihcalType="Al", string note="48fmR04"){
  ...
  infile_jesAfter[1].open(Form("txt_jet_wTot/jes_%s_%s_%s.out",szMeth[1].c_str(),ihcalType.c_str(),note.c_str()));
  ijes=0;
  ...
  leg1->AddEntry(gjesAfter[1],"After calib. (3par + tot)","lp");
  leg1->Draw();
...
//  c_JES->SaveAs(Form("outvsE_wTot/comp_JESvsE_%s_%s.pdf",ihcalType.c_str(),note.c_str()));
  ///////////////////////////////////////
...
//  c_JER->SaveAs(Form("outvsE_wTot/comp_JERvsE_%s_%s.pdf",ihcalType.c_str(),note.c_str()));
  ///////////////////////////////////////
/*  
