void comp_JER_pp_HI(string ihcalType="Al", string note1st="48fm", string note2nd="R02"){
  ...
  TFile* fin02 =  new TFile(Form("../z_20180912_wTot_HIJet_frompp/outvsE/JESvsE_%s_%s%s.root",ihcalType.c_str(),note1st.c_str(),note2nd.c_str()),"READ");
