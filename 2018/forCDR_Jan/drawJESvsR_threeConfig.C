...
void drawJESvsR_threeConfig(double ptmin = 50, double ptmax = 531, double etacut = 0.6, string varType="pt"){
  ...
  */
  ...
  TLegend* leg = new TLegend(0.63, 0.50, 0.93, 0.70);
  TLegend* leg2 = new TLegend(0.66, 0.72, 0.90, 0.94);
  leg2->SetTextSize(0.08);
  TLegend* leg3 = new TLegend(0.18, 0.24, 0.42, 0.46);
...
//    f03[ipt]->GetParameters(&par03[0]);
    ...
    if (ipt ==0) {
      leg->AddEntry(hReco01[ipt],"SS310","lp");
      leg->AddEntry(hReco02[ipt],"Al","lp");
      leg->AddEntry(hReco03[ipt],"Al uninst.","lp");
    }
    leg->Draw();
    c01[ipt]->SaveAs(Form("outJESvsR_threeConfig/hcal_jetcone%d.pdf",jetCone[ipt]));
...
//  gJESRatio03->SetMarkerSize(1.7);
  ...
  tmp = gJESRatio01->GetXaxis()->GetTitleSize();
  gJESRatio01->GetXaxis()->SetTitleSize(tmp*1.5);
  tmp = gJESRatio01->GetXaxis()->GetLabelSize();
  gJESRatio01->GetXaxis()->SetLabelSize(tmp*1.5);
  gJESRatio01->GetXaxis()->SetTitleOffset(1.14);
  gJESRatio01->GetYaxis()->SetTitle("Ratio to SS310");
  tmp = gJESRatio01->GetYaxis()->GetTitleSize();
  gJESRatio01->GetYaxis()->SetTitleSize(tmp*1.5);
  tmp = gJESRatio01->GetYaxis()->GetLabelSize();
  gJESRatio01->GetYaxis()->SetLabelSize(tmp*1.5);
  //tmp = gJESRatio01->GetYaxis()->GetTitleOffset();
  gJESRatio01->GetYaxis()->SetTitleOffset(0.92);
//  gJESRatio01->GetYaxis()->SetTitleOffset(1.8);
  gJESRatio01->GetYaxis()->CenterTitle(1);
  gJESRatio01->GetXaxis()->SetLimits(0.1,0.6);
  gJESRatio01->GetXaxis()->SetNdivisions(505);
  gJESRatio01->SetMinimum(0.89); 
  gJESRatio01->SetMaximum(1.11); 
  ...
  leg2->AddEntry(gJES01,"SS310","p");
  leg2->AddEntry(gJES02,"Al","p");
  leg2->AddEntry(gJES03,"Al uninst.","p");
  leg2->Draw();
  gPad->Update();
  gPad->Modified();

  //c_JES->SaveAs(Form("outJESvsR/JES_%s_etacut%.1f_dRcut%.1f.pdf",varType.c_str(),etacut,dRcut));
  c_JES->SaveAs("outJESvsR_threeConfig/hcal_JESvsR.pdf");
...
//  gJERRatio03->SetMarkerSize(1.7);
  ...
  tmp = gJERRatio01->GetXaxis()->GetTitleSize();
  gJERRatio01->GetXaxis()->SetTitleSize(tmp*1.5);
  tmp = gJERRatio01->GetXaxis()->GetLabelSize();
  gJERRatio01->GetXaxis()->SetLabelSize(tmp*1.5);
  gJERRatio01->GetXaxis()->SetTitleOffset(1.14);
  gJERRatio01->GetYaxis()->SetTitle("Ratio to SS310");
  tmp = gJERRatio01->GetYaxis()->GetTitleSize();
  gJERRatio01->GetYaxis()->SetTitleSize(tmp*1.5);
  tmp = gJERRatio01->GetYaxis()->GetLabelSize();
  gJERRatio01->GetYaxis()->SetLabelSize(tmp*1.5);
  //tmp = gJERRatio01->GetYaxis()->GetTitleOffset();
  gJERRatio01->GetYaxis()->SetTitleOffset(0.92);
//  gJERRatio01->GetYaxis()->SetTitleOffset(1.8);
  gJERRatio01->GetYaxis()->CenterTitle(1);
  gJERRatio01->GetXaxis()->SetLimits(0.1,0.6);
  gJERRatio01->GetXaxis()->SetNdivisions(505);
  gJERRatio01->SetMinimum(0.78); 
  gJERRatio01->SetMaximum(1.22); 
  gJERRatio01->GetYaxis()->SetNdivisions(505);
  ...
  leg3->AddEntry(gJES01,"SS310","p");
  leg3->AddEntry(gJES02,"Al","p");
  leg3->AddEntry(gJES03,"Al uninst.","p");
  leg3->Draw();
  gPad->Update();
  gPad->Modified();
  
  //c_JER->SaveAs(Form("outJESvsR/JER_%s_etacut%.1f_dRcut%.1f.pdf",varType.c_str(),etacut,dRcut));
  c_JER->SaveAs("outJESvsR_threeConfig/hcal_JERvsR.pdf");
