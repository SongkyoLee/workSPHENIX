void check_sortedRootFiles(){
  TFile* f01 = new TFile("sortedRootFiles/sorted_0to400_QCDJet_G4sPHENIX_jet4_30GeV_SS310_R04_doetopcut1_dodphicut1.root","READ");
  TFile* f02 = new TFile("sortedRootFiles/sorted_0to400_QCDJet_G4sPHENIX_jet4_30GeV_Al_R04_doetopcut1_dodphicut1.root","READ");
  TFile* f03 = new TFile("sortedRootFiles/sorted_0to400_QCDJet_G4sPHENIX_jet4_30GeV_Alframe_R04_doetopcut1_dodphicut1.root","READ");
  //TFile* f02 = new TFile("sortedRootFiles/sorted_0to400_QCDJet_G4sPHENIX_jet4_50GeV_Al_R02_doetopcut1_dodphicut1.root","READ");
  //TFile* f02 = new TFile("sortedRootFiles/sorted_0to400_QCDJet_G4sPHENIX_jet4_50GeV_Alframe_R04_doetopcut1_dodphicut1.root","READ");
  //TFile* f02 = new TFile("/Users/songkyolee/Documents/z_20180410_diffE_vtx0_gammaEMCALonly_eta045/sortedRootFiles/sorted_0to400_QCDJet_G4sPHENIX_jet4_50GeV_Alframe_doetopcut1_dodphicut1.root","READ");
  //TFile* f01 = new TFile("/Users/songkyolee/Documents/z_20180630_diffE_Al/sortedRootFiles/sorted_0to400_QCDJet_G4sPHENIX_jet4_50GeV_Al_R04_doetopcut1_dodphicut1.root","READ");
  //TFile* f02 = new TFile("/Users/songkyolee/Documents/z_20180630_diffE_Al/sortedRootFiles/sorted_0to400_QCDJet_G4sPHENIX_jet4_50GeV_Alframe_R04_doetopcut1_dodphicut1.root","READ");
