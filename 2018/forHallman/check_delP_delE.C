...
//  }
  ...
  TH2D* h_JER_JMR = new TH2D("h_JER_JPTR",";(E_{Jet}^{Reco}-E_{Jet}^{Truth}) / E_{Jet}^{Truth};(M_{Jet}^{Reco}-M_{Jet}^{Truth}) / M_{Jet}^{Truth}",100,-1,1,100,-1,1);
  TH2D* h_JER_JMR_abs = new TH2D("h_JER_JPTR_abs",";| E_{Jet}^{Reco}-E_{Jet}^{Truth} | / E_{Jet}^{Truth};| M_{Jet}^{Reco}-M_{Jet}^{Truth} | / M_{Jet}^{Truth}",100,0,1,100,0,1);
