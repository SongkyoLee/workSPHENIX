...
foreach ihcal (SS310 Alframe Al) 
  ...
  #foreach method (before method03 method04 method05)
    foreach energy (20GeV 30GeV 40GeV 50GeV)
      ...
      root -l -b -q final_qcdjet_et.C\(\"QCDJet\",\"$ihcal\",\"$energy\",$initfile,$endfile,1.00,$thiscemc,$thisihcal,$thisohcal,true,true\) >&logs/log_final_qcd_$method\_$initfile\_$endfile\_$energy\_$ihcal&
      sleep 3s
    end  
  end  
end  
