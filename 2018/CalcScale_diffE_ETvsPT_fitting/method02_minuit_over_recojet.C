...
{  
  ...
  for (int ievt=0; ievt <nevt; ievt++){
    ...
    h_origRESRecoJet->Fill( (reco_jet_origE-reco_gamma_cemcEsum)/reco_jet_origE );    
    h_emfrac_origRESRecoJet->Fill( true_jet_emfrac, (reco_jet_origE-reco_gamma_cemcEsum)/reco_jet_origE );
  ...
  for (int ievt=0; ievt <nevt; ievt++){
    ...
    h_RESRecoJet->Fill( (reco_jet_caliE-reco_gamma_cemcEsum)/reco_jet_caliE );    
    h_emfrac_RESRecoJet->Fill( true_jet_emfrac, (reco_jet_caliE-reco_gamma_cemcEsum)/reco_jet_caliE );
