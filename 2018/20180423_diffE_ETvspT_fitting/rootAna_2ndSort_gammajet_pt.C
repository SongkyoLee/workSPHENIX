...
void rootAna_2ndSort_gammajet_pt(string sampleType = "GammaJet",
                              string ihcalType = "Al",
                              string jetInE = "20GeV",
                              string jetOutE = "20GeV",
                              string vtxType = "nover",
                              int initfile=0,
                              int endfile =1000,
                              ...
                              bool dodphicut=false)
{
  ...
  string foutname = Form("./2ndSortedRootFiles/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_doetopcut%d_dodphicut%d_pt.root",initfile,endfile,sampleType.c_str(),jetOutE.c_str(),ihcalType.c_str(),(int)doetopcut,(int)dodphicut);
  ...
  for (int ievt=0; ievt<true_tree->GetEntries(); ievt++){ 
    ...
    //// *** reco jet e range (cut on reco)
		if (jetOutE.compare("allGeV")==0){ if (!(reco_gamma_pt > 20)) continue; }
    else if (jetOutE.compare("20GeV")==0){ if (!(reco_gamma_pt > 20 && reco_gamma_pt <30)) continue; }
    else if (jetOutE.compare("30GeV")==0){ if (!(reco_gamma_pt > 30 && reco_gamma_pt <40)) continue; }
    else if (jetOutE.compare("40GeV")==0){ if (!(reco_gamma_pt > 40 && reco_gamma_pt <50)) continue; }
    else if (jetOutE.compare("50GeV")==0){ if (!(reco_gamma_pt > 50 && reco_gamma_pt <60)) continue; }
/*
		if (jetOutE.compare("allGeV")==0){ if (!(reco_gamma_pt > 20)) continue; }
    else if (jetOutE.compare("20GeV")==0){ if (!(reco_gamma_pt > 20 && reco_gamma_pt <25)) continue; }
    else if (jetOutE.compare("25GeV")==0){ if (!(reco_gamma_pt > 25 && reco_gamma_pt <30)) continue; } 
    else if (jetOutE.compare("30GeV")==0){ if (!(reco_gamma_pt > 30 && reco_gamma_pt <35)) continue; }
    else if (jetOutE.compare("35GeV")==0){ if (!(reco_gamma_pt > 35 && reco_gamma_pt <40)) continue; }
    else if (jetOutE.compare("40GeV")==0){ if (!(reco_gamma_pt > 40 && reco_gamma_pt <45)) continue; }
    else if (jetOutE.compare("45GeV")==0){ if (!(reco_gamma_pt > 45 && reco_gamma_pt <50)) continue; }
    else if (jetOutE.compare("50GeV")==0){ if (!(reco_gamma_pt > 50 && reco_gamma_pt <55)) continue; }
    else if (jetOutE.compare("55GeV")==0){ if (!(reco_gamma_pt > 55 && reco_gamma_pt <60)) continue; }
*/
