...
foreach ihcal (SS310 Alframe Al)
  ...
  foreach method (before method01 method02 method03 method04 method05)
    foreach energy (20GeV 30GeV 40GeV 50GeV)
      ...
      awk '{for (I=1;I<=NF;I++) if ($I == "jes_sig/mean") {print $(I+2)};}' logs/log_final_qcd_$method\_$initfile\_$endfile\_$energy\_$ihcal >>txt_jes/jes_sigmean_$method\_$ihcal.out 
