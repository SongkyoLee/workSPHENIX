...
void check_punchthrough(int isOpt = 10,
                              ...
                              bool dodphicut=true)
{
  ...
  TH1D* h_JES_01 = new TH1D("h_JES_01",";Jet E_{Reco} / Jet E_{Truth};Counts",nbin,binmin,binmax);
...
//  tf_JER_02->Draw("same");
  ...
  c3->SaveAs(Form("out_punchthrough/punch_isOpt%d.pdf",isOpt));
