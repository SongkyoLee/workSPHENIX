...
void rootAna_ihcalScale(string inType = "SS310_PiPl_25GeV",int initfile=0,int endfile =500,float cemc_cut=0.5, float ihcal_cut=0.)
{
  bool do_E3x3 = true;
  bool do_E5x5 = true;
  bool do_clE = true;
  ...
  TH2D* h2D_outerTwo_frac_vs_diff_frac_E3x3 = new TH2D("h2D_outerTwo_frac_vs_diff_frac_E3x3","(ihcal_E + ohcal_E) / (Truth E - cemc_E);(ihcal_E - ohcal_E) / (ihcal_E + ohcal_E)",700,-1.,1.,700,0,2.);
  ////
  ...
  TH2D* h2D_outerTwo_frac_vs_diff_frac_E5x5 = new TH2D("h2D_outerTwo_frac_vs_diff_frac_E5x5","(ihcal_E + ohcal_E) / (Truth E - cemc_E);(ihcal_E - ohcal_E) / (ihcal_E + ohcal_E)",700,-1.,1.,700,0,2.);
  ////
  ...
  TH2D* h2D_outerTwo_frac_vs_diff_frac_clE = new TH2D("h2D_outerTwo_frac_vs_diff_frac_clE","(ihcal_E + ohcal_E) / (Truth E - cemc_E);(ihcal_E - ohcal_E) / (ihcal_E + ohcal_E)",700,-1.,1.,700,0,2.);
  ////////
  //// cut
  ////////
  ...
  TH2D* h2D_outerTwo_frac_vs_diff_frac_E3x3_cut = new TH2D("h2D_outerTwo_frac_vs_diff_frac_E3x3_cut","(ihcal_E + ohcal_E) / (Truth E - cemc_E);(ihcal_E - ohcal_E) / (ihcal_E + ohcal_E)",700,-1.,1.,700,0,2.);
  ////
  ...
  TH2D* h2D_outerTwo_frac_vs_diff_frac_E5x5_cut = new TH2D("h2D_outerTwo_frac_vs_diff_frac_E5x5_cut","(ihcal_E + ohcal_E) / (Truth E - cemc_E);(ihcal_E - ohcal_E) / (ihcal_E + ohcal_E)",700,-1.,1.,700,0,2.);
  ////
  ...
  TH2D* h2D_outerTwo_frac_vs_diff_frac_clE_cut = new TH2D("h2D_outerTwo_frac_vs_diff_frac_clE_cut","(ihcal_E + ohcal_E) / (Truth E - cemc_E);(ihcal_E - ohcal_E) / (ihcal_E + ohcal_E)",700,-1.,1.,700,0,2.);
  ////////////////////////////////////////////////////////
  ...
  for(int isim=0; isim<nsim; isim++){
    ...
    for(int itrk=0; itrk<track_n; itrk++){
      if (do_E3x3){    
        ...
        diff_frac = (ihcal_e-ohcal_e) / (ihcal_e+ohcal_e);
        //
        ...
        h2D_outerTwo_frac_vs_diff_frac_E3x3->Fill(diff_frac,outerTwo_frac);
      }
      if (do_E5x5){    
        ...
        h2D_outerTwo_frac_vs_diff_frac_E5x5->Fill(diff_frac,outerTwo_frac);
      }
      if (do_clE){    
        ...
        h2D_outerTwo_frac_vs_diff_frac_clE->Fill(diff_frac,outerTwo_frac);
      }
      ...
      if (cemc_E3x3[itrk] < cemc_cut && ihcal_E3x3[itrk]< ihcal_cut){
        if (do_E3x3){    
          ...
          h2D_outerTwo_frac_vs_diff_frac_E3x3_cut->Fill(diff_frac,outerTwo_frac);
        }
        if (do_E5x5){    
          cemc_e=cemc_E5x5[itrk]*cemc_sf;
          ihcal_e=ihcal_E5x5[itrk]*ihcal_sf;
          ...
          h2D_outerTwo_frac_vs_diff_frac_E5x5_cut->Fill(diff_frac,outerTwo_frac);
        }
        if (do_clE){    
          cemc_e=cemc_clE[itrk]*cemc_sf;
          ihcal_e=ihcal_clE[itrk]*ihcal_sf;
          ...
          h2D_outerTwo_frac_vs_diff_frac_clE_cut->Fill(diff_frac,outerTwo_frac);
        }
      } //end of cut
    } //end of ntrk loop
  }  //end of nsim loop
  ...
  h2D_outerTwo_frac_vs_diff_frac_E3x3->SetOption("colz");
  //
  ...
  h2D_outerTwo_frac_vs_diff_frac_E5x5->SetOption("colz");
  //
  ...
  h2D_outerTwo_frac_vs_diff_frac_clE->SetOption("colz");
  ////
  ...
  h2D_outerTwo_frac_vs_diff_frac_E3x3_cut->SetOption("colz");
  //
  ...
  h2D_outerTwo_frac_vs_diff_frac_E5x5_cut->SetOption("colz");
  //
  ...
  h2D_outerTwo_frac_vs_diff_frac_clE_cut->SetOption("colz");
  ...
  if (do_E3x3){    
    ...
    h2D_outerTwo_frac_vs_diff_frac_E3x3->Write();
  }
  if (do_E5x5){    
    h1D_cemc_E5x5->Write();
    ...
    h2D_outerTwo_frac_vs_diff_frac_E5x5->Write();
  }
  if (do_clE){    
    h1D_cemc_clE->Write();
    h1D_ihcal_clE->Write();
    ...
    h2D_outerTwo_frac_vs_diff_frac_clE->Write();
  }
  ...
  if (do_E3x3){    
    ...
    h2D_outerTwo_frac_vs_diff_frac_E3x3_cut->Write();
  }
  if (do_E5x5){    
    ...
    h2D_outerTwo_frac_vs_diff_frac_E5x5_cut->Write();
  }
  if (do_clE){    
    ...
    h2D_outerTwo_frac_vs_diff_frac_clE_cut->Write();
  } 
