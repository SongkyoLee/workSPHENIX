...
void fig04_JESJER(string ihcalType="Alframe"){
  ...
  int finalMeth = 2;
  if (ihcalType.compare("SS310")==0) {
//    jes_binmin = 1.069-0.12;
//    jes_binmax = 1.069+0.12;
//    jer_binmin = 0.134-0.015;
//    jer_binmax = 0.134+0.015;
//    jes_binmin = 1.067-0.12;
//    jes_binmax = 1.067+0.12;
...
//    jes_binmin = 1.016-0.12;
//    jes_binmax = 1.016+0.12;
//    jer_binmin = 0.185-0.015;
//    jer_binmax = 0.185+0.015;
//    jes_binmin = 1.016-0.12;
//    jes_binmax = 1.016+0.12;
...
//    jer_binmax = 0.190+0.025;
  ...
  SetLineHistStyle(h_jes_final,6);
  SetLineHistStyle(h_jer_final,6);
...
//  tf_jes_final->SetLineStyle(7);
  ...
  if (ihcalType.compare("SS310")==0) {sz_mean = "Instrumented Steel";}
  else  {sz_mean = "CD-1 Configuration";}
  myLatex(0.22,0.87,sz_mean.c_str(),12,0.065);
  sz_mean = Form ("#mu = %.2f", mean);
  myLatex(0.66,0.76,sz_mean.c_str(),12,0.06,kRed-4);
  sz_mean = Form ("#sigma/#mu = %.2f", sig/mean);
  myLatex(0.66,0.70,sz_mean.c_str(),12,0.06,kRed-4);
...
//  tf_jer_final->SetLineStyle(7);
  ...
  c_1d_2->SaveAs(Form("out_figs/hcal_jesjer_%s.pdf",ihcalType.c_str()));
 /* 
  //////////////////////////////////////////////////////////////////////////////////////////
  //// TGraph //////////////////////////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////////////////////////////////////
  ...
  c_jes->SaveAs(Form("out_stat/JESJERvsE_final_%s.pdf",ihcalType.c_str()));
  ...
  c_jer->SaveAs(Form("out_stat/JESJERvsE_final_%s.pdf",ihcalType.c_str()));


  
   
  TFile* fout =  new TFile(Form("out_stat/JESJERvsE_final_%s.root",ihcalType.c_str()),"RECREATE");
  fout->cd();
  gjes_final->Write();
  gjer_final->Write();
  fout->Close(); 
