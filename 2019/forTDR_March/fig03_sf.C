...
void fig03_sf(string ihcalType="Alframe"){
  ...
  TH1D* h_cemc_final = new TH1D("h_cemc_final",";A (EMCal^{had} Scale);Counts",30*1.2,cemc_binmin,cemc_binmax);
  TH1D* h_ihcal_final = new TH1D("h_ihcal_final",";B (Inner HCal Scale);Counts",30*1.2,ihcal_binmin,ihcal_binmax);
  TH1D* h_ohcal_final = new TH1D("h_ohcal_final",";C (Outer HCal Scale);Counts",30*1.2,ohcal_binmin,ohcal_binmax);
  h_cemc_final->Sumw2();
  h_ihcal_final->Sumw2();
  h_ohcal_final->Sumw2();
...
//  tf_cemc_final->SetLineStyle(7);
  ...
  //myLatex(0.22,0.88,ihcalType.c_str(),12,0.07);
  ...
  sz_mean = Form ("#mu = %.2f", mean);
  myLatex(0.65,0.76,sz_mean.c_str(),12,0.06,kRed-4);
  //sz_mean = Form ("#sigma = %.2f", sig);
  sz_mean = Form ("#sigma/#mu = %.2f", sig/mean);
  myLatex(0.65,0.70,sz_mean.c_str(),12,0.06,kRed-4);
...
//  tf_ihcal_final->SetLineStyle(7);
  ...
  myLatex(0.22,0.87,sz_mean.c_str(),12,0.065);
  sz_mean = Form ("#mu = %.2f", mean);
  myLatex(0.65,0.76,sz_mean.c_str(),12,0.06,kBlue-4);
  sz_mean = Form ("#sigma/#mu = %.2f", sig/mean);
  myLatex(0.65,0.70,sz_mean.c_str(),12,0.06,kBlue-4);
...
//  tf_ohcal_final->SetLineStyle(7);
  ...
  myLatex(0.22,0.87,sz_mean.c_str(),12,0.065);
  sz_mean = Form ("#mu = %.2f", mean);
  myLatex(0.65,0.76,sz_mean.c_str(),12,0.06,kGreen+2);
  sz_mean = Form ("#sigma/#mu = %.2f", sig/mean);
  myLatex(0.65,0.70,sz_mean.c_str(),12,0.06,kGreen+2);
  ...
  c_1d_2->SaveAs(Form("out_figs/hcal_sf_%s.pdf",ihcalType.c_str()));
/*
  //////////////////////////////////////////////////////////////////////////////////////////
  //// TGraph //////////////////////////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////////////////////////////////////
