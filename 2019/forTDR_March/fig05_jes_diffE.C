                              ...
                              bool dodphicut=true)
{
  ...
  string fname01 = Form("./2ndSortedRootFiles_diffE/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_doetopcut%d_dodphicut%d.root",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),(int)doetopcut,(int)dodphicut);
...
//  tf_JER_01->Draw("same");
  ...
  string fname02 = Form("./2ndSortedRootFiles_diffE/2ndSorted_%dto%d_%s_G4sPHENIX_jet4_%s_%s_doetopcut%d_dodphicut%d.root",initfile,endfile,sampleType.c_str(),jetE.c_str(),ihcalType.c_str(),(int)doetopcut,(int)dodphicut);
