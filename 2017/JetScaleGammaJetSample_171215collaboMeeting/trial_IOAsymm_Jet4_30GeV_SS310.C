void trial_IOAsymm_Jet4_30GeV_SS310(string ihcalType = "SS310",
                            string jetE="30GeV",
                            ...
                            int endfile =1000)
{
  ...
  float c_em=1.00;
  float c_h = 1.00;
  //float c_ih[ntr]={1.00, 2.70, 2.76, 2.77, 2.78, 2.79, 2.80, 2.90};
  float c_ih[ntr]={1.00, 1.10, 1.20, 1.30, 1.40, 1.50, 1.60, 1.70, 1.80, 1.90, 2.00, 2.50};
  float param[ntr];
  float error[ntr];
