...
void rootAna_matching_jet4_test(string ihcalType = "SS310",
                              string jetE = "20GeV",
  ...
  for (int ievt=0; ievt<10; ievt++){ 
    ...
    for (int ireco=0; ireco<reco_n; ireco++){
      ...
      if (tmp_jet_dR < match_jet_dR){
        ...
        reco_jet_cemcEsum = reco_cemcEsum[ireco]*cemc_sf; //scale
        ...
        cout << ""<<endl;
        cout << "reco_cemcEsum[ireco]"<<reco_cemcEsum[ireco]<<endl;
        cout << "reco_ihcalEsum[ireco]"<<reco_ihcalEsum[ireco]<<endl;
        ...
        cout << "reco_jet_totE"<<reco_jet_totE<<endl;
        cout << "reco_jet_outerTwo"<<reco_jet_outerTwo<<endl;
        cout << "reco_jet_outerTwoOverReco"<<reco_jet_outerTwoOverReco<<endl;
        cout << "reco_jet_IOAsymm"<<reco_jet_IOAsymm<<endl;
...
/*
  ...
  cout << Form("%s%s/gammajet_matched_%s_%s_scale_%.0f_%.0f_%.0f.root",outDir.c_str(),jetE.c_str(),jetE.c_str(),ihcalType.c_str(),cemc_sf*100,ihcal_sf*100,ohcal_sf*100) << endl;
*/  
  return; 
