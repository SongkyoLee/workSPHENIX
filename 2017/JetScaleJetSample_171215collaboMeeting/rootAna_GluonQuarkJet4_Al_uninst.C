...
void rootAna_GluonQuarkJet4_Al_uninst(string ihcalType = "Al_uninst",string jetE="50GeV",int initfile=0,int endfile =1000, int ver = 4, int patch =0)
{
...
//    float truthjet4_cons_pid[999];  // Al,, KYO: to be modified!!!!!
  ...
  TFile* fout = new TFile(Form("outJet4QGAlUninst/%s_%s_ByGammaJet_ver_%d_patch_%d.root",jetE.c_str(),ihcalType.c_str(),ver,patch),"RECREATE");
  fout->cd();
  ////
