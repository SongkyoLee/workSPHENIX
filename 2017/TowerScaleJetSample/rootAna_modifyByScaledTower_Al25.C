...
void rootAna_modifyByScaledTower_Al25(TString ihcalType = "MyTree_Al_NotScaled",int initfile=0,int endfile =1000)
{
...
//      float tower_ohcalsum = 0;
  ...
  TFile* fout = new TFile(Form("outModi/CEMCscale_%s_1p38_6p03_1p38.root",ihcalType.Data()),"RECREATE");
  fout->cd();
