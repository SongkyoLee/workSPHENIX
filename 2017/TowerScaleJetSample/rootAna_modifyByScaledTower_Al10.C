...
void rootAna_modifyByScaledTower_Al10(TString ihcalType = "MyTree_Al_NotScaled",int initfile=0,int endfile =1000)
{
...
//      float tower_ohcalsum = 0;
  ...
  TFile* fout = new TFile(Form("outModi/CEMCscale_%s_2p00_7p75_1p35.root",ihcalType.Data()),"RECREATE");
  fout->cd();
