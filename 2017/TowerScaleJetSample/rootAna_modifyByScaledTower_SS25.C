...
void rootAna_modifyByScaledTower_SS25(TString ihcalType = "MyTree_SS310_NotScaled",int initfile=0,int endfile =1000)
{
...
//      float tower_ohcalsum = 0;
  ...
  TFile* fout = new TFile(Form("outModi/CEMCscale_%s_1p39_2p52_1p39.root",ihcalType.Data()),"RECREATE");
  fout->cd();
