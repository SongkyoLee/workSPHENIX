                           ...
                           bool do_profile=true)
{
  ...
  c01->SaveAs(Form("%s/%s_2D_TOTE_vs_EHAsymm_%.0f_%.0f_%.0f_mipcut_%.0f_%.0f_totcut%.0f.pdf",outDir.c_str(),inType.c_str(),(int)do_cemcScale*c2nd*100,(int)do_ihcalScale*c1st*100,(int)do_totalScale*c3rd*100,(int)do_cemcMipCut*cemcCut*100,(int)do_ihcalMipCut*ihcalCut*100,(int)do_totMipCut*totCut*100));
