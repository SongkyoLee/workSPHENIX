...
void rootAna_GluonQuarkJet4_test(string ihcalType = "Al_uninst",string jetE="50GeV",int initfile=0,int endfile =1, float cemc_sf=1.00, float ihcal_sf=1.00, float ohcal_sf=1.00)
{
