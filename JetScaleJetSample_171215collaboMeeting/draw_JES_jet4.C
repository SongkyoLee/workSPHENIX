...
void draw_JES_jet4(string ihcalType="SS310",string jetE="20GeV", double fitmin=0.2, double fitmax=1.5, float cemc_sf=1.00, float ihcal_sf=1.00, float ohcal_sf=1.00){
