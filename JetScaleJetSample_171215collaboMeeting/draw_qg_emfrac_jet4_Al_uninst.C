...
void draw_qg_emfrac_jet4_Al_uninst(string ihcalType = "Al_uninst", string jetE="50GeV", int initfile=0,int endfile =1000, int ver=4,int patch=0)
{
...
//  float em_max = 0.6;
  ...
  TString fname = Form("./outJet4QGAlUninst/%s_%s_ByGammaJet_ver_%d_patch_%d.root",jetE.c_str(),ihcalType.c_str(),ver,patch);
  ...
  TF1 *f_calfrac = (TF1*)prof_calfrac->GetListOfFunctions()->FindObject("pol4");
  if (f_calfrac) { 
...
//  stat_emfrac->SetFillColor(0);
  ...
  c_emfrac->SaveAs(Form("./outJet4QGemfracAlUninst/%s_%s_JES_emfrac_ver_%d_patch_%d.pdf",jetE.c_str(),ihcalType.c_str(),ver,patch));
  ////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////
  ...
  TF1 *f_modi_calfrac = (TF1*)prof_modi_calfrac->GetListOfFunctions()->FindObject("pol4");
  if (f_modi_calfrac) { 
...
//  stat_modi_emfrac->SetFillColor(0);
  ...
  TF1 *f_modi_emfrac = (TF1*)prof_modi_emfrac->GetListOfFunctions()->FindObject("pol1");
  if (f_modi_emfrac) { 
...
//  c_modi_emfrac->SaveAs(Form("./outJet4QGemfrac%s/%s_modi_JES_emfrac_%.0f_%.0f_%.0f.pdf",jetE.c_str(),ihcalType.c_str(),cemc_sf*100,ihcal_sf*100,ohcal_sf*100));
  c_modi_emfrac->SaveAs(Form("./outJet4QGemfracAlUninst/%s_%s_modi_JES_emfrac_ver_%d_patch_%d.pdf",jetE.c_str(),ihcalType.c_str(),ver,patch));
  ////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////
  ...
  TF1 *f_quark_calfrac = (TF1*)prof_quark_calfrac->GetListOfFunctions()->FindObject("pol4");
  if (f_quark_calfrac) { 
...
//  stat_quark_emfrac->SetFillColor(0);
  ...
  TF1 *f_quark_emfrac = (TF1*)prof_quark_emfrac->GetListOfFunctions()->FindObject("pol1");
  if (f_quark_emfrac) { 
  ...
  c_quark_emfrac->SaveAs(Form("./outJet4QGemfracAlUninst/%s_%s_quark_JES_emfrac_ver_%d_patch_%d.pdf",jetE.c_str(),ihcalType.c_str(),ver,patch));
  ////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////
  ...
  TF1 *f_quark_modi_calfrac = (TF1*)prof_quark_modi_calfrac->GetListOfFunctions()->FindObject("pol4");
...
//  stat_quark_modi_emfrac->SetFillColor(0);
  ...
  TF1 *f_quark_modi_emfrac = (TF1*)prof_quark_modi_emfrac->GetListOfFunctions()->FindObject("pol1");
  ...
  c_quark_modi_emfrac->SaveAs(Form("./outJet4QGemfracAlUninst/%s_%s_quark_modi_JES_emfrac_ver_%d_patch_%d.pdf",jetE.c_str(),ihcalType.c_str(),ver,patch));
  ...
  TF1 *f_gluon_calfrac = (TF1*)prof_gluon_calfrac->GetListOfFunctions()->FindObject("pol4");
  if (f_gluon_calfrac) { 
...
//  stat_gluon_emfrac->SetFillColor(0);
  ...
  TF1 *f_gluon_emfrac = (TF1*)prof_gluon_emfrac->GetListOfFunctions()->FindObject("pol1");
  if (f_gluon_emfrac) { 
  ...
  c_gluon_emfrac->SaveAs(Form("./outJet4QGemfracAlUninst/%s_%s_gluon_JES_emfrac_ver_%d_patch_%d.pdf",jetE.c_str(),ihcalType.c_str(),ver,patch));
  ////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////
  ...
  TF1 *f_gluon_modi_calfrac = (TF1*)prof_gluon_modi_calfrac->GetListOfFunctions()->FindObject("pol4");
...
//  stat_gluon_modi_emfrac->SetFillColor(0);
  ...
  TF1 *f_gluon_modi_emfrac = (TF1*)prof_gluon_modi_emfrac->GetListOfFunctions()->FindObject("pol1");
  ...
  c_gluon_modi_emfrac->SaveAs(Form("./outJet4QGemfracAlUninst/%s_%s_gluon_modi_JES_emfrac_ver_%d_patch_%d.pdf",jetE.c_str(),ihcalType.c_str(),ver,patch));
